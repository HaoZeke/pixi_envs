...
integration tests on every push to =realDomDec= and on PRs. It checks
out =pixi_envs= alongside the GROMACS source and builds both thread-MPI
and real-MPI variants. Tests that need many ranks (dd8, dd12) are
skipped in CI.
** Development details
